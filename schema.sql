...
--peek at manager_info table
--why do only 5 out of 9 depts have managers??
SELECT * FROM manager_info;

-- add depts to current employees table
-- some people occuring twice
...
-- skill drill 
-- retirement eligible employee numbers, first_name, last_name, employee dept == SALES
...
--skill drill
-- retirement eligible employee numbers, first_name, last_name, employee dept in (Sales, Development)
SELECT ri.emp_no, ri.first_name,ri.last_name, d.dept_name 
--INTO mentors_info
FROM retirement_info AS ri
LEFT JOIN dept_emp AS de
